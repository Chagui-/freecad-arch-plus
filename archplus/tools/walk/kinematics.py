...
Units are FreeCAD internal: millimetres; angles are radians. No
FreeCAD/PySide/pivy imports here — everything must run headless under
pytest.

Movement is mouse-only (the user removed keyboard/WASD): the wheel steps
forward/back along the current view heading; looking is right-mouse drag.
...
mouse  screen y grows downward; the pitch sign also depends on the
       invert_y flag held by the controller.
"""
