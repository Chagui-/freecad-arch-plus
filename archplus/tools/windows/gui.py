...
_DIR = os.path.dirname(__file__)     # archplus/tools/windows/, for resources/
...
from archplus.common.spec import SPEC_PROP, storeSpec, readSpec  # noqa: F401
...
def repositionWindow(window, reopen=False):
    ...
    def _place(point=None, obj=None):
        ...
        try:
            ...
            # wall(s).
            window.touch()
            _recomputeWithHosts(window, swept)
